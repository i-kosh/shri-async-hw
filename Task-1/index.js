...
(function () {
   ...
   * последним аргументом идет коллбэк в функции которые возвращают промис
   *
   * @param {(...args, cb) => any} fn Функция с коллбэком
   ...
   * @param {(AsyncArray) => void} cb Коллбэк в который передатся новый массив
   *
